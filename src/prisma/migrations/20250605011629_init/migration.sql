...
CREATE TABLE "ItemProduct" (
    ...
    CONSTRAINT "ItemProduct_pkey" PRIMARY KEY ("orderId","productId")
);
...
-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_neighId_fkey" FOREIGN KEY ("neighId") REFERENCES "Neighborhood"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Order" ADD CONSTRAINT "Order_orderStateId_fkey" FOREIGN KEY ("orderStateId") REFERENCES "OrderState"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ItemProduct" ADD CONSTRAINT "ItemProduct_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "Order"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
